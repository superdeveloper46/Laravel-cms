                                ...
                                @forelse($all_survey as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('admin.survey.edit', $item->id) }}" class="icon-btn mr-1" data-toggle="tooltip" data-title="@lang('Edit')">
                                                <i class="la la-pencil-alt text--shadow"></i>
                                            </a>
                                            <a href="{{ route('admin.survey.all.question', $item->id) }}" class="icon-btn bg--success" data-toggle="tooltip" data-title="@lang('Questions')">
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.survey.new') }}" class="btn btn-sm btn--success"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
@endpush
